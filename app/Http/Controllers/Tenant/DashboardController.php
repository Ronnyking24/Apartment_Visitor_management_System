...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $totalVisits   = Visit::where('resident_id', $tenant->id)->count();
        $pendingVisits = Visit::where('resident_id', $tenant->id)->where('status', 'pending')->count();
        $todayVisits   = Visit::where('resident_id', $tenant->id)->whereDate('created_at', today())->count();
